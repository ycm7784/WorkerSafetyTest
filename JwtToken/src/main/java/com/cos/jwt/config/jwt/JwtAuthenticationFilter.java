...
//		RefreshToken refreshTokenfield =  new RefreshToken();;
//    	refreshTokenfield.setId(principalDetails.getmanager().getManagerid());
//    	refreshTokenfield.setRefreshToken(refreshToken);
//    	refreshTokenRepository.save(refreshTokenfield);
